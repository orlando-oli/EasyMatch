...
export default function CardEvento(){
    return (
      ...
      <View style={styles.cardTitleView}>
        ...
        <Text style={styles.cardTitle}>Round robin dos amigos - Clube</Text>
      </View>
      ...
      <View  style={styles.cardData}>
          ...
          <View style={styles.cardInfo}>
            <Text style={styles.cardLocalText}>Maracana de Futebol Society Zona Leste - 6.7km</Text>
            <View  style={styles.cardVagasView}>
              <Text style={styles.cardVagasN}>7</Text>
        ...
        <View style={styles.cardDescView}>
            <Text style={styles.cardDescText}> Ambiente Familiar onde as drogas entram pelas portas dos fundos somente, psilocibina 
              </Text>
        </View>
        <View style={styles.cardPlay}>
        <TouchableOpacity  style={styles.playButton}>
            <Text style={styles.playButtonText}>Participar!</Text>
          </TouchableOpacity>
        </View>
      </View>
    );
