...
const bg_color_cardHora = '#7b1fa2';
const bg_color_cardVagas = '#7b1fa2';
const bg_color_cardData = '#7b1fa2';
const bg_color_card = '#fdfdfd';
const bg_color_play = '#711c94';
const txt_color_light = '#e5e5e5';
const txt_color_vagas_dsp = '#b2fab4';
const txt_color_bright = '#fff';
const txt_color_cardTitle = '#333';
...
export default function feedScreen({navigation}) {
  ...
  useEffect(() => {
    async function loadEvents() {
      try {
        const response = await api.put('/events/all');
